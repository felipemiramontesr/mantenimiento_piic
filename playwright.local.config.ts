  ...
  projects: [
    {
      ...
      // FC 078 F4 — tableIntegrity también vive SOLO en los projects rwd-*.
      testIgnore: [
        '**/smoke.spec.ts',
        '**/audit/**',
        '**/responsive.spec.ts',
        '**/tableIntegrity.spec.ts',
      ],
    },
    ...
    // project corre SOLO las specs de gate RWD (cond.5 FC074: responsive;
    // FC 078 F4: + tableIntegrity — specs SEPARADAS, sin asserts cruzados).
    {
      name: 'rwd-mobile-360',
      use: { ...devices['Desktop Chrome'], viewport: { width: 360, height: 640 } },
      testMatch: ['**/responsive.spec.ts', '**/tableIntegrity.spec.ts'],
    },
    {
      name: 'rwd-mobile-390',
