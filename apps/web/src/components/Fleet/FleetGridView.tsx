      ...
      <div className="archon-grid-3 gap-5">
        ...
        >
          <div className="flex flex-col items-center p-8">
            <LayoutDashboard size={48} className="text-[#0f2a44]" />
            <h3 className="mt-4 font-black uppercase text-sm">Administración</h3>
          </div>
        </div>
        <div
          className="glass-card-pro archon-instrument-tile"
        ...
        >
          <div className="flex flex-col items-center p-8 cursor-pointer" onClick={onRegister}>
            <PlusCircle size={48} className="text-emerald-500" />
            <h3 className="mt-4 font-black uppercase text-sm">Registrar</h3>
          </div>
        </div>
        <div
          className="glass-card-pro archon-instrument-tile"
        ...
        >
          <div className="flex flex-col items-center p-8">
            <Wrench size={48} className="text-sky-500" />
            <h3 className="mt-4 font-black uppercase text-sm">Mantenimiento</h3>
          </div>
        </div>
      </div>
