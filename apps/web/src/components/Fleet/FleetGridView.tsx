      ...
      <div className="archon-grid-3 gap-5">
        ...
        >
          ...
          <div className="archon-tile-action">
            <button className="btn-sentinel-navy w-full">
              Ver Detalles <ArrowRight size={10} className="text-white ml-2" />
            </button>
          </div>
        </div>

        {/* Card 2: Registrar (EMERALD) */}
        <div
        ...
        >
          ...
          <div className="archon-tile-action">
            <button className="btn-sentinel-emerald w-full" onClick={onRegister}>
              Iniciar Registro <ArrowRight size={10} className="text-white ml-2" />
            </button>
          </div>
        </div>

        {/* Card 3: Mantenimiento (SKY) */}
        <div
        ...
        >
          ...
          <div className="archon-tile-action">
            <button className="btn-sentinel-sky w-full">
