...
const FleetModule: React.FC = (): React.ReactElement => {
  ...
  return (
    <main className="workspace-container-pro animate-in fade-in duration-700">
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
            ...
            <p className="text-[#0f2a44] text-[10px] font-bold uppercase tracking-[0.2em] opacity-60">
              {currentView === 'GRID'
                ? 'Gestión de Vehículos, Maquinaria y Herramientas • Industrial Grade'
                : 'Protocolo de Incorporación de Activo v.10.0.2'}
            </p>
          </div>
      ...
      {/* 📊 ÁREA DE TRABAJO DINÁMICA (Chasis v.10.0.2) */}
      ...
      <footer className="workspace-footer-pro">
        ...
        <p className="text-[#0f2a44]">ArchonCore Sovereign v.10.0.2</p>
      </footer>
    </main>
  );
};
