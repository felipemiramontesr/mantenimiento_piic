...
async function seed() {
  ...
  try {
    ...
    const tasks = [
      ...
      {
        code: 'STRICT_PREVENTIVE_INSPECT',
        label: 'Inspección preventiva más estricta',
        is_critical: 1,
      },
      {
        code: 'FLEET_ECONOMY_FOCUS',
        label: 'Énfasis en mantenimiento económico de flotilla',
        is_critical: 0,
      },
      {
        code: 'VITAL_POINTS_INSPECT',
        label: 'Inspección de puntos vitales del vehículo',
        is_critical: 1,
      },
      {
        code: 'CHASSIS_CARGO_INSPECT',
        label: 'Inspección de chasis y componentes de carga',
        is_critical: 1,
      },
      ...
      { code: 'BELTS_HOSES_CHECK', label: 'Revisión de bandas y mangueras', is_critical: 1 },
      {
        ...
        label: 'Revisión del sistema de enfriamiento',
        is_critical: 1,
      },
      // Standard 20K Brand Specific
      {
        code: 'PREVENTIVE_SECURITY_INSPECT',
        label: 'Inspección de seguridad preventiva',
        is_critical: 1,
      },
      {
        code: 'URBAN_DELIVERY_ADJUST',
        label: 'Ajustes orientados a uso urbano/reparto',
        is_critical: 0,
      },
      { code: 'CVT_COMPONENTS_CHECK', label: 'Revisión de componentes CVT', is_critical: 1 },
      {
        code: 'ELECTRICAL_BODY_CHECK',
        label: 'Revisión de sistema eléctrico y carrocería',
        is_critical: 0,
      },
      {
        code: 'AXLES_CARGO_INSPECT',
        label: 'Inspección de ejes y componentes de carga',
        is_critical: 1,
      },
      ...
      { code: 'INJECTORS_CLEANING', label: 'Limpieza de inyectores', is_critical: 1 },
      {
        ...
        label: 'Limpieza de cuerpo de aceleración',
        is_critical: 1,
      },
      ...
      {
        code: 'DEEP_STEERING_FUEL_CHECK',
        label: 'Revisión profunda de dirección y combustible',
        is_critical: 1,
      },
      { code: 'CVT_DEEP_FOCUS', label: 'Mayor enfoque en revisión CVT', is_critical: 1 },
      {
        code: 'STEERING_HEAVY_USE_FOCUS',
        label: 'Mayor enfoque en dirección y uso rudo',
        is_critical: 1,
      },
      {
        code: 'DEEP_DIFF_HEAVY_CARGO_CHECK',
        label: 'Revisión profunda de diferencial y carga pesada',
        is_critical: 1,
      },
      ...
      {
        code: 'DEEP_SUSPENSION_CHECK_ADV',
        label: 'Revisión profunda de suspensión',
        is_critical: 1,
      },
      ...
      { code: 'SHOCK_ABSORBERS_CHECK', label: 'Revisión de amortiguadores', is_critical: 1 },
      {
        ...
        label: 'Revisión de diferencial en SUV/pickups',
        is_critical: 1,
      },
      {
        code: 'ELECTRONIC_HYDRAULIC_STEERING_CHECK',
        label: 'Revisión de dirección electrónica/hidráulica',
        is_critical: 1,
      },
      {
        code: 'OFFROAD_DIFF_COMPONENTS_INSPECT',
        label: 'Inspección de diferenciales y componentes off-road',
        is_critical: 1,
      },
      {
        code: 'TOWING_CHASSIS_HEAVY_DIFF_CHECK',
        label: 'Revisión de remolque, chasis y diferenciales pesados',
        is_critical: 1,
      },
      ...
      { code: 'CABIN_FILTER_MINING', label: 'Reemplazo de filtro de cabina', is_critical: 0 },
      {
        ...
        label: 'Reemplazo de filtro separador de agua',
        is_critical: 1,
      },
    ];
    ...
    const brandRules = [
      ...
      { brand_id: 23, fuel_type_id: null, service_type: 'BASIC_10K', task_code: 'BASIC_WASH' },
      {
        ...
        task_code: 'STRICT_PREVENTIVE_INSPECT',
      },
      {
        brand_id: 37,
        fuel_type_id: null,
        service_type: 'BASIC_10K',
        task_code: 'FLEET_ECONOMY_FOCUS',
      },
      {
        brand_id: 35,
        fuel_type_id: null,
        service_type: 'BASIC_10K',
        task_code: 'VITAL_POINTS_INSPECT',
      },
      {
        brand_id: 33,
        fuel_type_id: null,
        service_type: 'BASIC_10K',
        task_code: 'CHASSIS_CARGO_INSPECT',
      },
      ...
      // 20K Brand rules
      {
        ...
        task_code: 'PREVENTIVE_SECURITY_INSPECT',
      },
      {
        brand_id: 37,
        fuel_type_id: null,
        service_type: 'INTERMEDIATE_20K',
        task_code: 'URBAN_DELIVERY_ADJUST',
      },
      {
        brand_id: 23,
        fuel_type_id: null,
        service_type: 'INTERMEDIATE_20K',
        task_code: 'CVT_COMPONENTS_CHECK',
      },
      {
        brand_id: 35,
        fuel_type_id: null,
        service_type: 'INTERMEDIATE_20K',
        task_code: 'ELECTRICAL_BODY_CHECK',
      },
      {
        brand_id: 33,
        fuel_type_id: null,
        service_type: 'INTERMEDIATE_20K',
        task_code: 'AXLES_CARGO_INSPECT',
      },
      ...
      // 30K Brand rules
      {
        ...
        task_code: 'ELECTRICAL_SYSTEM_CHECK',
      },
      {
        brand_id: 253,
        fuel_type_id: null,
        service_type: 'MAJOR_30K',
        task_code: 'DEEP_STEERING_FUEL_CHECK',
      },
      { brand_id: 23, fuel_type_id: null, service_type: 'MAJOR_30K', task_code: 'CVT_DEEP_FOCUS' },
      {
        ...
        fuel_type_id: null,
        service_type: 'MAJOR_30K',
        task_code: 'STEERING_HEAVY_USE_FOCUS',
      },
      {
        brand_id: 33,
        fuel_type_id: null,
        service_type: 'MAJOR_30K',
        task_code: 'DEEP_DIFF_HEAVY_CARGO_CHECK',
      },
      ...
      // 50K Brand rules
      {
        ...
        task_code: 'SHOCK_ABSORBERS_CHECK',
      },
      {
        brand_id: 253,
        fuel_type_id: null,
        service_type: 'ADVANCED_50K',
        task_code: 'SUV_PICKUPS_DIFF_CHECK',
      },
      {
        brand_id: 37,
        fuel_type_id: null,
        service_type: 'ADVANCED_50K',
        task_code: 'ELECTRONIC_HYDRAULIC_STEERING_CHECK',
      },
      {
        brand_id: 35,
        fuel_type_id: null,
        service_type: 'ADVANCED_50K',
        task_code: 'OFFROAD_DIFF_COMPONENTS_INSPECT',
      },
      {
        brand_id: 33,
        fuel_type_id: null,
        service_type: 'ADVANCED_50K',
        task_code: 'TOWING_CHASSIS_HEAVY_DIFF_CHECK',
      },
