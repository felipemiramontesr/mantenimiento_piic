...
/** GET /v1/notifications — last 10 for authenticated user (FC163 F2B3, split Alfa 227_AN). */
...
/** PATCH /v1/notifications/:id/read — mark as read, owner only (FC163 F2B3, split Alfa 227_AN). */
...
/** POST /v1/notifications/push-token — register FCM token (FC163 F2B3, split Alfa 227_AN). */
...
/** POST /v1/notifications/push-token/unregister — delete FCM token (FC163 F2B3, split Alfa 227_AN). */
