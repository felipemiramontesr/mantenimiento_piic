...
## SECCIÓN 13 — MODELO DE OPERACIÓN AUTÓNOMA (CC Y AG — VIGENTE DESDE 2026-06-11)
...
| **14** | **Validación Estricta de Tipos (Static TS)** | El typechecking via `tsc --noEmit` es obligatorio al finalizar cada tarea (Fase 4 del Pre-Flight Check) y en el pipeline de CI/CD (Archon Certification Dashboard) para garantizar que ningún cambio introduzca errores de tipado en el monorepo.                                                                                                                                                                                                                                                                                                          |
