-- 🔱 ARCHON INDUSTRIAL FLEET INJECTION v.2.0 (UUID SYNC)
-- Logic: High-Precision Relational Mapping with Unique UUID Generation.
-- Architecture: Sovereing Data Infrastructure (v.39.9.18)
...
(
    ...
    'L4 2.5L Turbo (2KD-FTV Diésel)', (SELECT id FROM common_catalogs WHERE code = 'DR_4X2' LIMIT 1),
    ...
    '8019-548-901', 80.0, 14850.00, '255/70 R15', 264, 269, 27, 
...
(
    ...
    'L4 2.5L DOHC Multipunto (Gasolina)', (SELECT id FROM common_catalogs WHERE code = 'DR_4X2' LIMIT 1),
    ...
    'Mina', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Arian Silver%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8019-400-922', 80.0, 13200.00, '255/60 R18', 265, 271, 24, 
...
(
    ...
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8012-548-390', 80.0, 13200.00, '205 R16', 266, 273, 26, 
...
(
    ...
    'L4 2.8L Turbo Intercooled (Diésel)', (SELECT id FROM common_catalogs WHERE code = 'DR_4X4' LIMIT 1),
    ...
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8019-548-190', 80.0, 14850.00, '265/65 R17', 244, 269, 28, 
...
(
    ...
    'L4 1.6L DOHC (Gasolina)', (SELECT id FROM common_catalogs WHERE code = 'DR_4X2' LIMIT 1),
    ...
    'Mina', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Huur%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8012-548-150', 41.0, 9800.00, '205/55 R16', 243, 272, 23, 
...
(
    ...
    2025, (SELECT id FROM common_catalogs WHERE code = 'F_GAS' LIMIT 1),
    'L4 1.5L DOHC (Gasolina)', (SELECT id FROM common_catalogs WHERE code = 'DR_4X2' LIMIT 1),
    ...
    'Mina', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Huur%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8019-548-190', 39.0, 9800.00, '185/60 R15', 243, 272, 23, 
...
(
    ...
    'V8 6.4L HEMI MDS (Gasolina)', (SELECT id FROM common_catalogs WHERE code = 'DR_4X4' LIMIT 1),
    ...
    'Planta', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Arian Silver%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8019-548-390', 197.0, 14850.00, '235/80 R17', 244, 273, 26, 
...
(
    ...
    'L4 2.4L MIVEC Turbo (Diésel)', (SELECT id FROM common_catalogs WHERE code = 'DR_4X4' LIMIT 1),
    ...
    'Mina', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Arian Silver%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8019-548-901', 75.0, 14850.00, '265/60 R18', 244, 271, 24, 
...
(
    ...
    'Mina', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Arian Silver%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8019-548-914', 75.0, 14850.00, '245/70 R16', 244, 269, 275, 
...
(
    ...
    'Mina', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Arian Silver%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8012-548-140', 75.0, 14850.00, '245/70 R16', 244, 269, 28, 
...
(
    ...
    'Mina', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Arian Silver%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8019-548-901', 42.0, 9800.00, '185/60 R15', 243, 272, 23, 
...
(
    ...
    'L4 1.3L Firefly (Gasolina)', (SELECT id FROM common_catalogs WHERE code = 'DR_4X2' LIMIT 1),
    ...
    'Planta', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Arian Silver%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8012-548-390', 55.0, 9800.00, '185/60 R15', 243, 273, 276, 
...
(
    ...
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8019-548-390', 45.0, 9800.00, '185/65 R15', 243, 272, 23, 
...
(
    ...
    'Mina', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Huur%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8012-548-150', 80.0, 14850.00, '265/65 R17', 244, 269, 275, 
...
(
    ...
    'Mina', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Huur%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8012-548-140', 80.0, 14850.00, '265/65 R17', 244, 270, 27, 
...
(
    ...
    'Mina', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Huur%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8012-548-150', 80.0, 14850.00, '265/65 R17', 244, 269, 27, 
...
(
    ...
    (SELECT id FROM common_catalogs WHERE code = 'M_TOY_YAR' LIMIT 1),
    2023, (SELECT id FROM common_catalogs WHERE code = 'F_DSL' LIMIT 1),
    'L4 1.5L (Dato a verificar)', (SELECT id FROM common_catalogs WHERE code = 'DR_4X2' LIMIT 1),
...
(
    ...
    'L4 1.4L TSI Turbo (Gasolina)', (SELECT id FROM common_catalogs WHERE code = 'DR_4X2' LIMIT 1),
    ...
    'Mina', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Huur%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8019-548-901', 50.0, 9800.00, '215/55 R17', 243, 274, 23, 
...
(
    ...
    2023, (SELECT id FROM common_catalogs WHERE code = 'F_DSL' LIMIT 1),
    'L4 2.0L CTI Turbo (Diésel)', (SELECT id FROM common_catalogs WHERE code = 'DR_4X4' LIMIT 1),
    ...
    'Mina', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Arian Silver%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8019-548-902', 76.0, 14850.00, '265/60 R18', 244, 269, 275, 
...
(
    ...
    2024, (SELECT id FROM common_catalogs WHERE code = 'F_GAS' LIMIT 1),
    'L4 2.0L Turbo (Dato a verificar)', (SELECT id FROM common_catalogs WHERE code = 'DR_4X2' LIMIT 1),
    ...
    'Mina', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Arian Silver%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8019-548-901', 60.0, 13200.00, '195/70 R15C', 267, 273, 25, 
...
(
    ...
    'Mina', (SELECT id FROM common_catalogs WHERE category = 'FLEET_OWNER' AND label LIKE '%Huur%' LIMIT 1),
    (SELECT id FROM common_catalogs WHERE category = 'COMPLIANCE_STATUS' AND label = 'Cumple' LIMIT 1),
    '8012-548-140', 80.0, 14850.00, '265/65 R17', 244, 269, 27, 
...
-- =============================================================================
-- MIGRATION COMPLETE: Client Fleet v.2.0 (UUID SYNC TOTAL) SEEDED
-- =============================================================================
