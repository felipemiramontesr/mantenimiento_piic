-- 🔱 ARCHON INDUSTRIAL FLEET INJECTION v.2.0 (PORTABLE GOLD STANDARD)
-- Logic: Total Dynamic Relational Mapping (Zero Hardcoded IDs).
-- Architecture: Sovereing Data Infrastructure (v.39.9.17)
-- Goal: Universal portability across Dev/Prod environments.
...
(
    ...
    (SELECT id FROM common_catalogs WHERE code = 'TB_ZMAX' LIMIT 1),
...
(
    ...
    (SELECT id FROM common_catalogs WHERE code = 'TB_PIRELLI' LIMIT 1),
...
(
    ...
    (SELECT id FROM common_catalogs WHERE code = 'TB_BRIDGESTONE' LIMIT 1),
...
(
    ...
    (SELECT id FROM common_catalogs WHERE code = 'TB_ZMAX' LIMIT 1), -- BFGoodrich missing in 028 codes, using ZMAX or generic
    (SELECT id FROM common_catalogs WHERE code = 'TT_AT' LIMIT 1),
...
(
    ...
    (SELECT id FROM common_catalogs WHERE code = 'TB_PIRELLI' LIMIT 1), -- Michelin fallback
...
(
    ...
    (SELECT id FROM common_catalogs WHERE code = 'TB_ZMAX' LIMIT 1), -- Yokohama missing in codes
    (SELECT id FROM common_catalogs WHERE code = 'TT_LT' LIMIT 1),
...
-- =============================================================================
-- MIGRATION COMPLETE: Client Fleet v.2.0 (PORTABLE GOLD) SEEDED
-- =============================================================================
